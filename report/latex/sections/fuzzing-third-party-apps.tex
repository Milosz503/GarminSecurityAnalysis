...
I can see two possible explanations for this behaviour.
Firstly, probably the most likely, there is a bug during the initial parsing/loading of the application that triggers the profiler.
Or maybe a no documented feature of the simulator.
Secondly, there is a chance that the application started the profiler from the virtual machine.

(TODO: write about testing those apps on the watch)
